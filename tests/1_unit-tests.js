...
suite('Unit Tests', () => {
    suite("Translate to British English", function(){
        test("Translate Mangoes are my favorite fruit. to Britsh English", function(done){
            assert.equal(
        ...
        test("Translate I ate yogurt for breakfast. to Britsh English", function(done){
            assert.equal(
        ...
        test("Translate We had a party at my friend's condo. to Britsh English", function(done){
            assert.equal(
        ...
        test("Translate Can you toss this in the trashcan for me?. to Britsh English", function(done){
            assert.equal(
        ...
        test("Translate The parking lot was full. to Britsh English", function(done){
            assert.equal(
        ...
        test("Translate Like a high tech Rube Goldberg machine. to Britsh English", function(done){
            assert.equal(
        ...
        test("Translate To play hooky means to skip class or work. to Britsh English", function(done){
            assert.equal(
        ...
        test("Translate No Mr. Bond, I expect you to die. to Britsh English", function(done){
            assert.equal(
        ...
        test("Translate Dr. Grosh will see you now. to Britsh English", function(done){
            assert.equal(
        ...
        test("Translate Lunch is at 12:15 today. to Britsh English", function(done){
            assert.equal(
    ...
    suite("Translate to American English", function(){
        ...
        test("Translate Tea time is usually 4 or 4.30. to American English", function(done){
            assert.equal(
                translator.toAmericanEnglish("Tea time is usually 4 or 4.30.")[0],
                "Tea time is usually 4 or 4:30."
            );
            done();
        });
    });
